...
#we then use this function to move the ve
# We also need a function to generate a random direction
...
def returnRandomNMoveDirection(cell,nextWorld):
    ...
    # generate a random value for x and y which are in the neighbour region
    # create the new cell location
    # if we didn't move (random value for x & y was 0) then just return the current locatoin
    # if we moved, call the isValidDirection function to see if the new location is valid
